...
for (let newUsername of new_users) {
    const usernameExists = current_users.some((currentUsername) => currentUsername.toLowerCase() === newUsername.toLowerCase());
    if (usernameExists) {
...
//=====================QUESTION 37============================//
function makeshirt(size = 'LARGE', message = "I ❤ TypeScript") {
    console.log(`You've ordered a ${size}-sized shirt with the message: "${message}"`);
}
// Calling the function
...
console.log(album3);
//======================== QUESTION 41 ===============================//
let magicianNames = ["john", "james", "briyan", "andrew"];
